...
**103 files / 9920 declaration lines**. Grep this directory before opening source:
...
| Infrastructure | 27 | `symbols/Infrastructure-<area>.md` |
| Other product projects | 51 | `symbols/<project>.md` |
